...
import type { EventCategory, EventRow, UserRole } from '@/types/database'
  ...
  return (
    <div className="max-w-5xl mx-auto px-4 py-8">
      <div className="flex flex-wrap items-end justify-between gap-4 mb-6">
        <div>
          <h1 className="text-4xl font-black uppercase tracking-wider">Camp Calendar</h1>
          <p className="text-gray-600 mt-1">
            Everything NYC Deli Rats is doing — meetings, deadlines, socials, builds and events.
          </p>
        </div>
        {isAdmin && (
